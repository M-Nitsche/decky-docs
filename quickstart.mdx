...
<Tabs>
  <Tab title="Claude.ai web (OAuth)">
    ...
    <Steps>
      ...
      <Step title="Sign in to Decky">
        Claude redirects you to Decky's sign-in page. Use the same account as [platform.decky-ai.com](https://platform.decky-ai.com). If you don't have one, a free account is created automatically.
      </Step>
  ...
  <Tab title="Claude Desktop">
    <Steps>
      <Step title="Get your API key">
        ...
        3. Click **Create key**, name it (e.g. "Claude Desktop"), and click **Create**.
      ...
      <Step title="Restart Claude Desktop">
        Quit and reopen Claude Desktop. A tools icon appears in the chat input — click it to confirm Decky's tools are listed.
      </Step>
      <Step title="Generate a deck">
  ...
  <Tab title="Claude Code">
    <Steps>
      <Step title="Get your API key">
        Create one at [platform.decky-ai.com](https://platform.decky-ai.com) → **API Keys**. Copy it immediately.
      </Step>
