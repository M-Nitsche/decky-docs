...
<Note>
Templates are uploaded via the dashboard at [platform.decky-ai.com](https://platform.decky-ai.com) → **Templates** (max 3 per account). If the array is empty, Decky uses its default design.
</Note>
